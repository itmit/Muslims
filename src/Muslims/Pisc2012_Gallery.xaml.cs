...
namespace Muslims
{
	...
	public partial class Pisc2012_Galley : ContentPage
	{
        ...
        public void Gallery_Item_Init()
        {
            ...
            {
                new Gallery_Image { Image_Path = "Y2012pisc_1_.jpg"},
                new Gallery_Image { Image_Path = "Y2012pisc_2_.jpg"},
                new Gallery_Image { Image_Path = "Y2012pisc_3_.jpg"},
                new Gallery_Image { Image_Path = "Y2012pisc_4_.jpg"},
            };
